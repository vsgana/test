...
resource "aws_instance" "writer_instance" {
  ...
  iam_instance_profile   = aws_iam_instance_profile.writer_profile2.name # ✅ declared in iam.tf
...
resource "aws_instance" "reader_instance" {
  ...
  key_name               = aws_key_pair.TF_key.key_name
  iam_instance_profile   = aws_iam_instance_profile.reader_profile2.name # ✅ from iam.tf
